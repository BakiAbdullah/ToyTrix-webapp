          ...
          <div className="shadow-2xl rounded-lg w-4/5 h-96 bg-cover bg-center bg-[url('/banner11.jpg')]">
            <div className="grid grid-cols-12 gap-1">
              ...
              <div
                ...
                data-aos-mirror="true"
                data-aos-once="false"
                className="col-span-12 sm:col-span-12 md:col-span-5 lg:col-span-5 xxl:col-span-5"
              >
                <div className="relative bg-cyan-900 h-full md:h-96 w-full bg-opacity-50 rounded-tr-lg rounded-br-lg">
                  <div className="p-8">
                    <p className="text-white text-xs md:text-sm lg:text-xl mb-4">
                      ...
                      benefits young children. If you want your child to get a
                      positive start in life, it’s important to provide them
                      with enjoyable activities that also nurture brain
                      development, improve eye/hand coordination, get a child
                      thinking and analysing, as well as learning new skills.
                      Many toys and activities are educational, and providing
                      Legos for toddlers is one such toy that offers numerous
